...
class MapCampaign extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    // componentDidMount(){
    //     axios.get("/api/profiles-in-campaign/"+this.props.advance.advance_id).then(res=>{
    ...
    render() {
        ...
        return (
            <div>
                {(this.props.profiles.length ===0)? <div className="no_map_data"><h1>No Data for Map</h1></div>:
                <div className="map_campaign_container">
